...
{
	import com.iwobanas.effects.effectClasses.SlideUpInstance;

	/**
	 * The SlideUp class defines slide up effect.
	 * Depending on <code>showTarget</code> property value 
	 * the target component disappears (when <code>false</code>) 
	 * or appears (when <code>true</code>) by sliding upward.
	 */
	public class SlideUp extends Slide
	{
		/**
		 *  Constructor.
		 *
